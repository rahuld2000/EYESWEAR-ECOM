...
function Footer() {
  return (
    <div className="w-full h-[750px] bg-[#111111] text-white p-10 flex flex-col justify-between">
      <div className=" flex justify-between ">
        <div>
          ...
          <div className="flex mt-5">
            {" "}
            <input
              className="p-4 bg-[#212121] w-96"
              type="text"
              placeholder="Enter Your Email Address"
            />
            <button className="w-24 bg-[#E7FF56]">
      ...
      <div>
        <p className="text-[400px] font-Antonio font-bold text-[#212121] relative -top-6 leading-[1.1] max-md:text-[10rem]">
          CHICLOBE
        </p>
      </div>
